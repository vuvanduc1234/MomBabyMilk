  ...
  return (
    <div className="w-full max-w-[260px] border border-[#f1d4e0] rounded-[14px] p-4 flex flex-col items-center gap-3 bg-white">
      ...
      <label className="w-full">
        ...
        />
        <span
          className={`block w-full text-center px-3 py-2 rounded-[10px] border border-[#f1d4e0] text-[13px] font-semibold text-[#2b2730] transition ${
            loading
              ? "opacity-50 cursor-not-allowed"
              : "cursor-pointer hover:bg-[#fde7f0]"
          }`}
        >
