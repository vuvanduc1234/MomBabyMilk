...
export default function NewArticleDialog({ open, onOpenChange, onSave }) {
  ...
  const editor = useEditor({
    ...
    content: "<p>Bắt đầu viết bài viết của bạn...</p>",
    editorProps: {
      attributes: {
        class:
  ...
  const handleSubmit = async () => {
    ...
    const articleData = {
      ...
      tags: tags
        ...
        .filter(Boolean),
      image: imageUrl.trim(),
      recommended_products: selectedProducts.map((p) => p._id),
    };
  ...
  const handleReset = () => {
    ...
    setImageUrl("");
    setSelectedProducts([]);
    editor?.commands.setContent("<p>Bắt đầu viết bài viết của bạn...</p>");
  };
