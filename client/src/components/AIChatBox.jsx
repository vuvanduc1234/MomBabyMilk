            ...
            {!user ? (
              <div className="text-center text-gray-500 mt-16 px-4">
                ...
                <p className="text-sm mb-4">
                  Bạn cần đăng nhập để sử dụng tính năng AI tư vấn sữa cho mẹ và bé.
                </p>
                <a
                  href="/login"
                  className="inline-block bg-pink-500 hover:bg-pink-600 text-white px-6 py-2 rounded-lg text-sm font-medium transition-colors"
                >
                  Đăng nhập ngay
                </a>
              </div>
          ...
          >
            <div className="flex gap-2">
              <input
                ...
                placeholder={user ? "Nhập câu hỏi của bạn..." : "Vui lòng đăng nhập để chat"}
